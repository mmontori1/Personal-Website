			...
			<Wrapper>
				<LinkWrapper>
					<Link href = "mailto:mmontori@umich.edu">
						<FooterIcon svg = {mailLogo} fill = {primary}/>
					</Link>
					<Link href = "https://www.github.com/mmontori1">
						<FooterIcon svg = {githubLogo} fill = {primary}/>
					</Link>
				</LinkWrapper>
				<LinkWrapper>
					<Link href = "https://www.linkedin.com/in/mariano-montori-37a2a5127/">
						<FooterIcon svg = {linkedInLogo} fill = {primary}/>
					</Link>
					<Link href = "https://devpost.com/mmontori1">
						<FooterIcon svg = {devpostLogo} fill = {primary}/>
					</Link>
				</LinkWrapper>
			</Wrapper>
		)
